...
var useSubscription = function(args, handler) {
  ...
  var executeSubscription = useCallback(function() {
    var assign;
    unsubscribe.current();
    assign = pipe(client.executeSubscription(request, devtoolsContext), subscribe(_ref)), 
...
export { Client, CombinedError, Consumer, Context, Mutation, Provider, Query, Subscription, cacheExchange, composeExchanges, createClient, createRequest, debugExchange, dedupExchange, defaultExchanges, fallbackExchangeIO, fetchExchange, ssrExchange, subscriptionExchange, useMutation, useQuery, useSubscription };
